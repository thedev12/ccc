...
// File: contracts/ZKPOODLEToken.sol
...
contract ZKPOODLE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = address(0x2E2D2973441f054dE0D885F77B3689338B796884);
    address public devWallet = address(0x92405601C7F3C3D84138eA7b24aA60eE85f30a24);
    address public charityWallet = address(0xe5F43BC24814dDa5371bC9d7fFc74F411567f4aC);

    uint8 public rewardsFee = 10;
    uint8 public liquidityFee = 10;
    uint8 public marketingFee = 10;
    uint8 public charityFee = 3;
    uint8 public devFee = 2;
    ...
    constructor() ERC20("ZKPoodle", "ZKPUP") {
    ...
    function swapAndDistribute(uint256 tokens) private {
        ...
        swapAndSendToFee(newBalance.mul(walletfees).div(totalFees - liquidityFee),walletfees);
        swapAndSendDividends(newBalance.mul(rewardsFee).div(totalFees - liquidityFee));
